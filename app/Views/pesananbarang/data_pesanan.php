                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php if ($row['status_dokumen'] == 'Draft') : ?>
                                                    <a type="button" href="leburbarang/<?= $row['id_date_lebur'] ?>" class="btn btn-block btn-outline-danger btn-sm">Draft</a>
                                                <?php else : ?>
                                                    <a type="button" href="leburbarang/<?= $row['id_date_lebur'] ?>" class="btn btn-block btn-outline-info btn-sm">Detail</a>
                                                <?php endif ?>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
