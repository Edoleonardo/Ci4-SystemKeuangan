      ...
      <div class="card-body">
        <div class="row">
          ...
          <div class="col-12 col-sm-6">
            ...
            <div class="card">
              <?php if (substr($barang['barcode'], 0, 1) == 1) : ?>
                  ...
                  <table class="table table-head-fixed text-nowrap">
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          <div>
                            <a href="/print/<?= $barang['barcode'] ?>" rel="noopener" target="_blank" class="btn btn-default"><i class="fas fa-print"></i> <br> <?= $barcode ?></a>
                            </h4>
                          </div>
                        </td>
                        <td>Nama Supplier :</td>
              ...
              <?php endif; ?>
              <?php if (substr($barang['barcode'], 0, 1) == 2) : ?>
                <div class="card-body table-responsive p-0">
                  <table class="table table-head-fixed text-nowrap">
                    <tbody>
                      <tr>
              ...
              <?php endif; ?>
              <?php if (substr($barang['barcode'], 0, 1) == 3) : ?>
                <div class="card-body table-responsive p-0">
                  <table class="table table-head-fixed text-nowrap">
                    <tbody>
                      <tr>
              ...
              <?php endif; ?>
              <?php if (substr($barang['barcode'], 0, 1) == 4) : ?>
                <div class="card-body table-responsive p-0">
                  <table class="table table-head-fixed text-nowrap">
                    <tbody>
                      <tr>
              ...
              <?php endif; ?>
              <?php if (substr($barang['barcode'], 0, 1) == 5) : ?>
                <div class="card-body table-responsive p-0">
                  <table class="table table-head-fixed text-nowrap">
                    <tbody>
                      <tr>
              ...
              <?php endif; ?>
              <?php if (substr($barang['barcode'], 0, 1) == 6) : ?>
                <div class="card-body table-responsive p-0">
                  <table class="table table-head-fixed text-nowrap">
                    <tbody>
                      <tr>
