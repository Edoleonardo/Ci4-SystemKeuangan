                        ...
                        <tbody>
                            ...
                            <?php foreach ($tampildata as $row) : ?>
                                <tr>
                                    ...
                                    <td><input onfocus="this.select()" style="width: 100px;" id="harganow <?= $row['id_detail_penjualan'] ?>" class="harganow form-control" onchange="UbahHarga(<?= $row['id_detail_penjualan'] ?>,<?= $row['id_date_penjualan'] ?>,<?= substr($row['kode'], 0, 1) ?>,<?= $row['qty'] ?>,<?= $row['berat'] ?>)" type="number" class="form-control" value="<?= $row['harga_beli'] ?>"></td>
