...
<table style='border:none;'>
  <tbody>
    <tr>
      <td style='border:none; width: 160mm;'><?= barcodegenerate($datacuci['no_cuci']) ?></td>
      <td style='border:none;'>No.Nota : <?= $datacuci['no_cuci'] ?><br>Tangerang, <?= date('d-m-y') ?><br>Nama Tukang: <?= $datacuci['nama_tukang'] ?></td>
    </tr>
  </tbody>
</table>
<br><br><br><br><br>
