...
class ModelLebur extends Model
{
    ...
    protected $allowedFields = ['nama_img', 'id_date_lebur', 'id_karyawan', 'no_lebur', 'kode', 'jenis', 'model', 'keterangan', 'berat', 'qty', 'tanggal_lebur', 'status_dokumen', 'total_harga_bahan'];
