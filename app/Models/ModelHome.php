...
class ModelHome extends Model
{
    ...
    protected $allowedFields = ['barcode', 'status', 'no_faktur', 'tgl_faktur', 'nama_supplier', 'qty', 'jenis', 'model', 'keterangan', 'merek', 'kadar', 'berat_bersih', 'berat_kotor', 'nilai_tukar', 'ongkos/harga', 'total_harga', 'kode_beli', 'gambar'];
