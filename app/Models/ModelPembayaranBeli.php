...
class ModelPembayaranBeli extends Model
{
    ...
    protected $allowedFields = ['id_pembayaran ', 'id_date_pembelian', 'nama_bank', 'qty', 'jumlah_pembayaran', 'cara_pembayaran', 'kode_rongsok', 'kode_retur', 'kode_24k', 'berat_murni', 'updated_at', 'created_at'];
