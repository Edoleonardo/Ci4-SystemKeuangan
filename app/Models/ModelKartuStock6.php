...
class ModelKartuStock6 extends Model
{

    protected $table = 'tbl_kartustock_6';
    protected $primaryKey = 'id_kartustock_6';
    ...
    public function getKartuFilter($id, $stock, $kode)
    {
        ...
        $data = $db->query('select * from tbl_kartustock_6 where ' . $qty . ' and ' . $search . ' and ' . $row . ' order by created_at DESC ' . $lim . ' ');
        return $data->getResult('array');
    }
