...
class ModelDetailPenjualan extends Model
{
    ...
    protected $allowedFields = ['id_date_penjualan', 'nama_img', 'kode', 'jenis', 'qty', 'model', 'keterangan', 'berat_bersih', 'berat_kotor', 'harga_beli', 'kadar', 'nilai_tukar', 'merek', 'total_harga'];
